...
//                return false;
    ...
    private void createList() {
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(VideoListPlayActivity.this);
        recyclerView.setLayoutManager(layoutManager);

        videoAdapter = new VideoAdapter(new ArrayList<>(), VideoListPlayActivity.this);
...
//        Toast.makeText(VideoListActivity.this, "URL Called: " + call.request().url(), Toast.LENGTH_SHORT).show();
        ...
        call.enqueue(new Callback<VideoList>() {
            ...
            public void onFailure(@NonNull Call<VideoList> call, @NonNull Throwable t) {
                ...
                Toast.makeText(VideoListPlayActivity.this, getString(R.string.api_error), Toast.LENGTH_SHORT).show();
                isLoading = false;
                swipeRefreshLayout.setRefreshing(false);
            }
        });
